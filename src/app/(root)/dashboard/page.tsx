...
export default function Dashboard() {
    return (
        <div className="px-5 py-5 lg:px-20 lg:py-10 h-[calc(100vh-64px)] w-full">
            <div className="min-h-full w-full grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-5 pb-10 2xl:pb-0">
                <div className="flex flex-col h-full justify-between gap-5">
                            ...
                            <div className="flex gap-4">
                                <div className="flex flex-col items-center relative">
                                    <Image
                                        ...
                                        height={100}
                                        width={100}
                                        className="rounded-full object-cover sm:w-24 sm:h-24 w-16 h-16"
                                    />

                                    <h2 className="text-base sm:text-lg font-semibold">
                                        Kamal
                                    </h2>
                                    <MdVerified className="h-5 w-5 text-green-500 absolute top-0 left-0 sm:top-1 sm:left-1" />
                                </div>
                                <div className="flex">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="text-xs sm:text-sm">No</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <CardTransition delay={0.75} className="w-full h-full">
                    ...
                    <div className="w-full h-full flex flex-col bg-primary rounded-lg p-8 text-white">
                        ...
                        <div className="flex flex-col gap-5 w-full">
                            <div className="flex w-full">
                                <h3 className="text-xs sm:text-base font-semibold w-1/2">
                                    Vehicle Number
                                </h3>
                                <p className="w-1/2 text-end text-xs sm:text-base">
                                    DL16T3458
                                </p>
                            </div>
                            <div className="flex w-full">
                ...
                <div className="w-full flex flex-col gap-5 md:col-span-2 2xl:col-span-1">
                    <CardTransition>
                        <div className="w-full p-4 flex flex-col bg-[#FFF0B6] rounded-lg relative">
                            ...
                            <p className="mt-5 text-xs text-primary font-semibold">
                                At speed of 60km/hr, you will reach your
                    ...
                    <CardTransition className="h-full" delay={0.75}>
