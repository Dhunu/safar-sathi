...
export default function AboutUs() {
    return (
        <div className="max-w-screen-lg mx-auto py-10 pt-20 flex flex-col text-primary gap-32">
            <CardTransition>
                <div className="flex flex-col gap-5">
                    ...
                    <div>
                        ...
                        <p className="text-sm">
                            At EcoFreight, we are committed to revolutionizing
                            the logistics industry by reducing deadheading and
                            promoting sustainable transportation. Our mission is
                            to create a seamless and efficient trucking network
                            that minimizes empty miles, maximizes resource
                    ...
                    <div>
                        ...
                        <p className="text-sm">
                            ...
                            industry&apos;s most pressing issues: deadheading.
                            Our team comprises logistics experts, software
                    ...
                    <div>
                        ...
                        <p className="text-sm">
                            ...
                            transform the way goods are transported, one load at
                            a time
                        </p>
                    </div>
                </div>
            ...
            <CardTransition delay={0.65}>
                <div className="flex flex-col">
                    ...
                    <p className="text-sm font-semibold">
                        ...
                        <span className="font-bold">Safar Sathi</span>, contact
                        us at:
                    </p>
